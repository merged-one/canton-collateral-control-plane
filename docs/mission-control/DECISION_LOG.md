...
| D-0013 | 2026-03-28 | Pin the Quickstart LocalNet foundation by upstream commit, use overlay-first customization, and stop at compose-preflight until the Daml runtime bridge is explicit. | Accepted | [ADR 0012](../adrs/0012-quickstart-demo-foundation.md) |
