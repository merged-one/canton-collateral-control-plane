...
The repository now has a pinned Quickstart bootstrap and compose-preflight foundation plus first IDE-ledger-backed end-to-end margin-call and substitution demos, but the remaining roadmap still applies because the Control Plane DAR is not yet deployed into Quickstart and no live asset adapter exists yet.
